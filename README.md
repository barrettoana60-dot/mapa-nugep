...
A busca prioriza resultados brasileiros, mostra um marcador no endereço escolhido e possui fallback entre provedores. Pontos importados são agrupados automaticamente em níveis de zoom menores, evitando travamentos em planilhas grandes.
